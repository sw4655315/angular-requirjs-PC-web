...
(function() {
  ...
  app.directive('selectAddress', function($http, $q, $compile) {
    ...
    delay = $q.defer();
    templateURL = '/JS/assets/angular-select-address/template/index.html';
    cityURL = '/JS/assets/angular-select-address/template/city.min.js';
      ...
      link: function(scope, element, attrs) {
        ...
        return delay.promise.then(function(data) {
          $http.get(templateURL).success(function(template) {
            ...
            $('body').append($template[0]);
			$('body').append($template[2]);
